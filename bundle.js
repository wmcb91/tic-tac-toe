...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameOver = function gameOver(value, result) {
	  var winner = value;
	  if (result === true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var allowMove = function allowMove(index) {
	...
	var gameWon = function gameWon(index, value) {
	  var cells = app.user.game.cells;
	  cells[index] = value;

	  if (cells[0] === cells[1] && cells[0] === cells[2] && cells[0] !== '' || cells[0] === cells[3] && cells[0] === cells[6] && cells[0] !== '' || cells[0] === cells[4] && cells[0] === cells[8] && cells[0] !== '' || cells[1] === cells[4] && cells[1] === cells[7] && cells[1] !== '' || cells[2] === cells[5] && cells[2] === cells[8] && cells[2] !== '' || cells[3] === cells[4] && cells[3] === cells[5] && cells[3] !== '' || cells[6] === cells[7] && cells[6] === cells[8] && cells[6] !== '' || cells[6] === cells[4] && cells[6] === cells[2] && cells[6] !== '') {
	    //game is over
	...
	var gameTied = function gameTied(index, value) {
	  var cells = app.user.game.cells;
	  cells[index] = value;
	...
	var changePlayer = function changePlayer(player) {
	  // if (allowMove === false) {
	...
	var executeTurn = function executeTurn(index) {
	  console.log('click');
	  // is valid move?
	  ...
	  if (gameWon(index, value) === true) {
	    ...
	    api.updateGame(index, value, true).done(render.updateGameSuccess).fail(render.updateGameFailure);
	    return;
	    // debugger;
	  }
	  ...
	  // allowed else to run without return?
	      ...
	      api.updateGame(index, value, false).done(render.updateGameSuccess).fail(render.updateGameFailure);
